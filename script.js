(function () {
  ...
  /* ── SCROLL: Progress-Bar + Parallax (rAF-gedrosselt, Layout-Werte gecacht) ── */
  ...
  /* ── CURSOR GLOW (rAF-gedrosselt, nur transform) ── */
  ...
  /* ── HERO MAUS-PARALLAX + HOVER-ZOOM (rAF-gedrosselt) ── */
  ...
  /* Wisch-Navigation (links/rechts) für die Vollbild-Galerien auf dem Handy */
